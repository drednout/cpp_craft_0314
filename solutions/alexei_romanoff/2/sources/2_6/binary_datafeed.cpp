...
namespace solution_2_6 {
    ...
    class StockMsg {
        ...
        public:
            ...
            solution_2_6::StockError read_from_stream(std::ifstream &input_file) {
                stock_name = new char[stock_name_size + 1/*\0*/];
            ...
            solution_2_6::StockError write_to_stream(std::ofstream &output_file) {
...
int main(int argc, char **argv) {
    ...
    while(input) {
        solution_2_6::StockMsg msg; 
        solution_2_6::StockError error_code = msg.read_from_stream(input);
        if (error_code != solution_2_6::ERROR_OK) {
            if (input.eof()) {
        ...
        msg.set_stock_name_size(solution_2_6::output_stock_name_size);
